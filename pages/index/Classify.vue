...
<template>
  <div class="classify-container">
    <ul relative>
      ...
      <div class="category top-0 left-160px z-10 p-6" @mouseleave="showCategory = false" @mouseenter="showCategory = true" rounded display-none absolute h-400px w-634px bg="#fdfdfd">
