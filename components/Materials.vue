...
<template>
  <div :class="center ? 'center' : 'materials'">
    <div class="note">
      ...
      <span w-99px h-28px text="#4d555d" class="b b-#4d555d" rounded-5px text-center cursor-pointer leading-26px @click="noteClick"> 查看 </span>
    </div>
    <div class="note">
      <img src="/images/materials.png" h-83px w-83px />
      <div text-16px color="#666666" mt-7px mb-12px>课程资料</div>
      <span @click="showModal" w-99px h-28px text="#4d555d" class="b b-#4d555d" rounded-5px text-center cursor-pointer leading-26px> 下载 </span>
    </div>
